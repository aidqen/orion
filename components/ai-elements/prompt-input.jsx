	...
	return (
		...
		>
			{data.mediaType?.startsWith("image/") && data.url ? (
				...
				<div className="flex size-full items-center justify-center text-neutral-500 dark:text-neutral-400">
	...
	return (
		<Textarea
			className={cn(
				...
				// Light/Dark readable text and placeholder
				"text-neutral-900 placeholder:text-neutral-500 dark:text-neutral-100 dark:placeholder:text-neutral-400",
...
export const PromptInputModelSelectTrigger = ({ className, ...props }) => (
	<SelectTrigger
		className={cn(
			...
			'hover:bg-neutral-100 hover:text-neutral-950 [&[aria-expanded="true"]]:bg-neutral-100 [&[aria-expanded="true"]]:text-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:[&[aria-expanded="true"]]:bg-neutral-800 dark:[&[aria-expanded="true"]]:text-neutral-50',
			className,
		)}
		{...props}
	/>
