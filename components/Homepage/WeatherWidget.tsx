...
export function WeatherWidget() {
	...
	if (isLoading) {
		return (
			<div className="bg-card rounded-3xl border border-border p-3 flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.02)] font-sans min-h-[120px]">
	...
	return (
		<div className="bg-sidebar dark:bg-card rounded-3xl border border-border p-3 flex flex-col justify-between shadow-[0_2px_8px_rgba(0,0,0,0.02)] font-sans gap-2">
			<div className="flex justify-between items-start w-full">
				<button className="grid grid-cols-[3fr_1fr] items-center gap-1 text-muted-foreground text-[15px] font-medium bg-transparent border-none cursor-pointer p-0">
					<span
			...
			<div className="flex justify-between items-end w-full">
				<span className="text-[42px] font-extralight text-foreground leading-none tracking-tighter">
					{weather.temperature}°C
				</span>

				<div className="flex flex-col text-muted-foreground items-end gap-0">
