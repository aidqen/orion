...
export const CreateEventPreview: React.FC<CreateEventPreviewProps> = ({ data, messageId }) => {
    ...
    return (
        <div className="w-full min-w-[250px] sm:min-w-[400px] max-w-full">
            <div className="w-full my-2 overflow-hidden rounded-xl border bg-card text-card-foreground shadow-sm">
