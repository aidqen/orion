		...
		<Modal open={open} onOpenChange={onOpenChange}>
			...
			<div className="flex h-[56px] items-center justify-between border-b border-border px-4 py-4">
				...
				<div className="flex items-center text-sm">
					<span>Close</span>
					<span className="ml-[6px] whitespace-nowrap rounded-[4px] bg-border px-[6px] py-[2px] text-muted-foreground">
						⌘ K
					</span>
				</div>
			</div>
			...
			<div className="flex flex-col gap-[2px] p-3 max-h-[600px] overflow-y-auto">
				{filteredChats.length > 0 && (
					<>
						<div className="mb-2 ml-2 text-[12px] font-semibold text-muted-foreground">
							Chats
						</div>
