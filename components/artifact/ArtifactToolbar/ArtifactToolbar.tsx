import { ChevronDown, Copy, Download, X, Check } from "lucide-react";
...
export function ArtifactToolbar({ closeArtifact }: ArtifactToolbarProps) {
    ...
    const { mutate: createDoc, isPending } = useMutation({
        ...
        onError: (error) => {
            ...
            toast.error('Failed to create Google Doc, try again later. If the problem persists, please contact support.');
        },
    }); 
